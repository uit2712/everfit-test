...
use Core\Features\Cache\Repositories\CacheRepository;
...
class Cache {
	...
	public function set( $key, $value, $ttl = null ) {
		return $this->repo->set( $key, $value, $ttl );
	}
	...
	public function getMultiple( $keys, $default = null ) {
		return $this->repo->getMultiple( $keys, $default );
	}
	...
	public function setMultiple( $values, $ttl = null ) {
		return $this->repo->setMultiple( $values, $ttl );
	}
	...
	public function deleteMultiple( $keys ) {
		return $this->repo->deleteMultiple( $keys );
	}
	...
	public function getKeys( string $pattern ): array {
		return $this->repo->getKeys( $pattern );
	}
	...
	public function getMultipleKeepKeys( $keys, $default = null ) {
		return $this->repo->getMultipleKeepKeys( $keys, $default );
	}
}
